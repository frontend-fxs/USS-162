document.addEventListener("DOMContentLoaded", function() {
    ...
    window.setTimeout(function() {
        if (windowWidth > 768) {
            document.querySelector('#fxs_custom_notification_body').classList.add('fxs_top_left');
        } else {
        ...
        if (windowWidth > 768) {
            ...
            document.querySelector('#fxs_custom_notification_close').addEventListener('click', function() {
                document.querySelector('#fxs_custom_notification_body').classList.remove('fxs_top_left');
            ...
            document.querySelector('#fxs_custom_notification_close').addEventListener('click', function() {
                document.querySelector('#fxs_custom_notification_body').classList.remmove('fxs_top');
            });
            document.querySelector('#fxs_custom_notification_link').addEventListener('click', function() {
                document.querySelector('#fxs_custom_notification_body').classList.remmove('fxs_top');
            });
